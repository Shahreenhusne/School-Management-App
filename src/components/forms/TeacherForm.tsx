...
const schema = z.object({
  ...
  .max(20, {message: "Username must be at max 20 characters long."}),
        ...
        <span className="text-xs text-gray-500 font-medium">Authentication Information</span>
         <div className="flex justify-between flex-wrap gap-4">
          ...
          {/* select menu */}
            ...
            {/* file upload */}
            <FileUpload register={register} error={errors.img} />
        </div>
     <button className="bg-secondary-alt1/80 text-white p-2 rounded-md">
